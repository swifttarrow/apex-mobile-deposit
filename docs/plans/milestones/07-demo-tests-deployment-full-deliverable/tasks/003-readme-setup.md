# Task 003: README & Setup

## Goal

Write README with setup, architecture overview, test account conventions, how to demo.
...
- From gaps: Pre-Search reference, performance targets

## Verification

- Fresh clone; README instructions work
